...
namespace DomainModelTest
{
    public class VehicleRentalContextHelper
    {
        ...
        {
            DomainModel.VehicleRentalContext queryContext = new DomainModel.VehicleRentalContext();
            ...
            //context.VehicleMakes.AddOrUpdate(vehicleMakes.ToArray());
            //context.MotorVehicleModels.AddOrUpdate(vehicleModels.ToArray());
